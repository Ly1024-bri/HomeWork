...
public class Test01 {
	...
	public static void test1(String str){
		System.out.println("输出长度:"+str.length());
	}
	public static void test2(String str){
		System.out.println("输出第一个o:"+str.indexOf("o"));
	}
	public static void test3(String str){
		System.out.println("输出后一个o:"+str.indexOf("o",5));
	}
	public static void test4(String str){
		System.out.println("输出Hello:"+str.substring(0,5));
	}
	public static void test5(String str){
		System.out.println("输出World:"+str.substring(5,str.length()));
	}
	public static void test6(String str1){
		System.out.println("除去空白:"+str1.trim());
	}
	public static void test7(String str){
		System.out.println("输出w:"+str.charAt(5));
	}
	public static void test8(String str){
		System.out.println("是否以h开头:"+str.startsWith("h"));
		System.out.println("是否以ld结束:"+str.endsWith("ld"));
